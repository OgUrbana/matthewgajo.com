    ...
    >
      <path
        ...
        className={cn(
          ...
          disabled ? "fill-[#999999]" : "fill-[#007AFF] hover:fill-[#007AFF]/60"
        )}
      />
    </svg>
  );
